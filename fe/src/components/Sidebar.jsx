...
export default function Sidebar() {
  ...
  return (
    <aside className={`fixed left-0 top-0 h-screen w-[280px] bg-[#040404] border-r border-white/5 flex flex-col px-6 pt-6 ${playerHeightPadding} z-30 transition-all duration-300`}>
      {/* Brand Logo */}
